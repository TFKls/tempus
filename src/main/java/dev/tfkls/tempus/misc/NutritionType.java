...
public enum NutritionType {
    ...
    static class Tags {
        public static final TagKey<Item> CARBOHYDRATE =
                TagKey.of(RegistryKeys.ITEM, new Identifier("tempus", "nutrition_carbohydrate"));
        public static final TagKey<Item> FAT = TagKey.of(RegistryKeys.ITEM, new Identifier("tempus", "nutrition_fat"));
        public static final TagKey<Item> PROTEIN =
                TagKey.of(RegistryKeys.ITEM, new Identifier("tempus", "nutrition_protein"));
    }
        ...
        private static void addNutritionStatusEffect(PlayerEntity player, StatusEffect effect, int amplifier) {
            if (amplifier > 0) {
                player.addStatusEffect(new StatusEffectInstance(
                        effect, Tempus.config.nutritionStatusEffectDuration, amplifier - 1, true, false, true));
            }
        }
    }
}
